      ...
      <div className="min-h-screen bg-[#1A252A] text-white p-4 font-sans">
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <button
              type="submit"
              className=" font-bold bg-gradient-to-r from-[#94783E] via-[#F3EDA6] via-[#F8FAE5] via-[#FFE2BE] to-[#D5BE88] bg-clip-text text-transparent text-sm hover:underline"
            >
              Save
            </button>
          </div>
          ...
          >
            {image ? (
              ...
              <div className="h-14 w-14 rounded-xl bg-[#1F2A30] flex items-center justify-center">
                <span className="text-2xl font-bold bg-gradient-to-r from-[#94783E] via-[#F3EDA6] via-[#F8FAE5] via-[#FFE2BE] to-[#D5BE88] bg-clip-text text-transparent">＋</span>
              </div>
            )}
